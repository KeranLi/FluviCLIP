...
"""
Training script for Res2Net baseline.
"""
import os
import torch
import numpy as np
...
from models.resnet import Res2Net
from configs.Res2Net import Config
...
if __name__ == "__main__":
    ...
    model = Res2Net(in_channels=26, layers=[3, 4, 6, 3], num_classes=1, scale=4).to(device)
